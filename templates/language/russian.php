...
return array(
    ...
    'ml_ok' => 'Сообщения поставленны в очередь',
    'ml_ok_inactive' => 'Черновик сохранен',
    'ml_sent_filter' => 'Фильтр',
    'ml_sex_select_error' => 'Необходимо выбрать хотя бы один фильтр',
    ...
    'ml_delete' => 'Удалить',
    'ml_delete_confirm' => 'Вы уверенны что хотите удалить рассылку?',
    'ml_yes' => 'Да',
    'ml_no' => 'Нет',
    'ml_cancel' => 'Отменить',
    'ml_save' => 'Сохранить',
    'ml_no_list' => 'Рассылки отстутствуют',
    'ml_send_all' => 'Разосланно полностью',
