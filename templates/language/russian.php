...
return array(
    ...
    'lsdigest_usub_digest_already' => 'Вы уже отказаться от дайджест рассылки',
    'lsdigest_usub_already' => 'Вы уже отказаться от рассылок',
    'lsdigest_usub_complete_digest' => 'Вы успешно отказаться от дайджест рассылки',
