...
с пользователями?).
* Возможность делать рассылку на email пользователя или через личные сообщения.
* Возможность пользователя отписаться от email рассылки.
...
--------------
v0.3.1
- Добавлена возможность рассылки ЛС пользователям.
- Добавлена возможность пользователю отписаться от рассылок писем (не ЛС) - ссылка в конце письма и настрока в профиле пользователя.
